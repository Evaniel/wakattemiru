...
/*
 * var appはアプリのコンテキストを代表してくれる変数です。
 * それで、このアップには幾つかの機能があり、その機能はそのappというオブジェクトに定義されます。
*/
var app = {
    ...
    tirarFoto: function(){
        if (!navigator.camera) {
            alert("Cordovaプラグ・インがインストールされていません。", "エラー！");
            return;
        }
        ...
        navigator.camera.getPicture(
            ...
            function(e) {
                alert(e);
                alert('Cameraプラグ・インはインストールされましたが、getPictureは失敗しました。', 'エラー！');
            }, options2);
